...
export default function NotFoundPage() {
  ...
  return (
    <div style={{ padding: 0 }}>
      <div className="certificate" ref={contentRef}>
        <div className="college_header_data">
          <div>
            <img src="https://imgs.search.brave.com/38sO-RhrVTS5l6YGyKabRxXt_5Hl3WmxfYhKDMuV7Fw/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/Y2hhcnVzYXQuYWMu/aW4vYWRtaXNzaW9u/L2ltYWdlcy9Mb2dv/LUNJUFMxLmpwZw" alt="this is image" />
          </div>
          <div>
            <p className="college_name">
              CHARUSAT <br />
              CSPIT <br />
              Smt. Kundanben Dinsha Patel Department of <br /> Information Technology
            </p>
          </div>
          <div>
            <img src="https://imgs.search.brave.com/38sO-RhrVTS5l6YGyKabRxXt_5Hl3WmxfYhKDMuV7Fw/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/Y2hhcnVzYXQuYWMu/aW4vYWRtaXNzaW9u/L2ltYWdlcy9Mb2dv/LUNJUFMxLmpwZw" alt="this is image" />
        ...
        <div className="letter_content">
          ...
          <div className="noc_main_data_section">
            <p className="noc_data">
              ...
              Post
              graduate programs in Electronics & Communication Engineering, Computer Engineering, Information
              Technology Electrical engineering, Mechanical and Civil Engineering.<br /><br />

              The students of semester 4th / 6th of Smt. KundanbenDinsha Patel Department of Information
              Technology of
              our Institute are required to undergo industrial training as a part of their academic course content
              of
              ...
              from
              15/05/2022 to 15/06/2022. <br /><br />

              In case any issue arises, it should be immediately brought to the notice of the
              Training & Placement Officer in the department <br /><br />
